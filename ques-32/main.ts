let current_users : string[] =["Adam Levin","Robert Downy","Tony stark","Oppenhimer"]

let new_users :string[] = ["Jira","Adam Levin","Michael","Oppenhimer","Eric"]
...
let case_sensitive:any[] = current_users.map((val)=>{
